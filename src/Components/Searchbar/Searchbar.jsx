...
export default function Searchbar() {
    ...
    // Filter Search Data
    const FilterDate = searchData.filter((obj) => obj.name.toLowerCase().includes(search)).slice(0, 8)
    return (
        <div className="">
            {/* search input  */}
            ...
            <div className=" flex justify-center">
                {search && <div className="block absolute bg-gray-200 w-96 md:w-96 lg:w-96 z-50 my-1 rounded-lg px-2 py-2">
                    {FilterDate.length > 0 ?
                        ...
                        <>
                            <div className="flex justify-center">
                                <img className=" w-20" src="https://easydrawingguides.com/wp-content/uploads/2018/10/UFO-10.png" alt="img" />
                            </div>
                        </>}
                </div>
                }
