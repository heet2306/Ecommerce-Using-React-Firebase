...
export default function Product() {
    return (
        <Layout><section className="py-5 lg:py-16 font-poppins dark:bg-gray-800">
                ...
                <div className="flex flex-wrap mb-24 -mx-4">
                    ...
                    <div className="w-full px-4 md:w-1/2">
                        <div className="lg:pl-20">
                            ...
                            <div className="flex flex-wrap items-center mb-6">
                                <button
                                    className="w-full px-4 py-3 text-center  text-white bg-teal border  hover:bg-teal1  rounded-xl"
                                >
                                    Add To Cart
                                </button>
                            </div>
