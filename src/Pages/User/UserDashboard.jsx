            ...
            <div className=" container mx-auto px-4 py-5 lg:py-8">
                ...
                <div className="top ">
                    ...
                    <div className=" bg-teal py-5 rounded-xl border ">
                        ...
                        {/* text  */}
                        <div className="">
                            <h1 className=" text-center text-lg"><span className=" font-bold">Name :</span>Alien Buddy</h1>
                            <h1 className=" text-center text-lg"><span className=" font-bold">Email :</span> Alien@gmail.com</h1>
                        </div>
                    </div>
                </div>
                ...
                <div className="bottom">
                    ...
                    <div className="mx-auto my-4 max-w-6xl px-2 md:my-6 md:px-0">
                        ...
                        <div className="mt-5 flex flex-col overflow-hidden rounded-xl border border-pink-100 md:flex-row">
                            {/* main 3  */}
                            <div className="w-full border-r bg-teal md:max-w-xs">
                                {/* left  */}
                                <div className="p-8">
